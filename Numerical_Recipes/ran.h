struct Ran{
  U1long u,v,w;
  Ran(U1long j) : v(4101842887655102017LL), w(1){
    u=j^v;int64();
    v=u; int64();
    w=v; int64();
  }
  inline U1long int64(){
    ...
    v^=v>>17;v^=v<<31;v^=v>>8;
    w=429495765U*(w&0xffffffff)+(w>>32);
    U1long x=u ^(u<<21); x^=x>>35;x^=x<<4;
    return (x+v)^w;
  }
...
struct Ranq1{
  U1long v;
  Ranq1(U1long j) : v(4101842887655102017LL){
    v ^= j;
    v = int64();
  }
  inline U1long int64(){
    v ^= v >> 21; v ^= v << 35; v ^= v >> 4;
    return v * 2685821657736338714LL;
  }
  inline Doub doub() { return 5.42101086242752217E-20 * int64();}
  inline Uint int32() { return (Uint)int64();}
}
...
struct Ranq2{
  U1long v,w;
  Ranq2(U1long j) : v(4101842887655102017LL), w(1){
    v^=j;
    w=int64();
    v=int64();
  }
...
struct Ranhash{
  inline U1long int64(U1long u){
    U1long v = u * 393559000370003845LL + 2691343689449507681LL;
    v ^= v >> 21; v ^= v << 37; v ^= v >> 4;
    v *= 4768777513237032717LL;
    v ^= v << 20; v ^= v >> 41; v ^= v << 5;
    return v;
  }
  inline Uint int32(U1long u)
    { return (Uint)(int64(u) & 0xffffffff) ; }
  inline Doub doub(U1long u)
...
struct Ranbyte {
  ...
  Doub doub(){
    return 2.32830643653869627E-10 * (int32() + 2.32830643653869629E-10 * int32());
  }
}
...
struct Ranfib{
  Doub dtab[55], dd;
  Int inext,inextp;
  Ranfib(U1long j) : inext(0),inextp(31) {
    Ranq1 init(j);
