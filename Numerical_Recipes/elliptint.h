Doub rf(const Doub x, const Doub y, const Doub z){
  static const Doub ERRTOL=0.0025, THIRD=1.0/3.0,C1=1.0/24.0,C2=0.1,C3=3.0/44.0,C4=1/14.0;
...
Doub rj(const Doub x,const Doub y,const Doub z, const Doub p){
  ...
  Doub a,alamb,alpha,ans,ave,b,beta,delp,delx,dely,delyz,ea,eb,ec,ed,ee,fac,
