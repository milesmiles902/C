struct Erf{
  ...
  /*
   * erf(x)=2/sqrt(pi) * int_0_x e^-t^2 dt;
   */
  ...
  /*
   * erfc(x)=1-erf(x)=2/sqrt(pi) * int_x_inf e^-t^2 dt;
   */
  ...
  const Doub Erf::cof[28]={-1.3026537197817094,6.4196979235649026e-1.
    1.9476473204185836e-2,-9.561514786808631e-3,-9.465953444482036e-4,
  ...
  Doub erfcc(const Doub x){
    Doub t,z=fabs(x),ans;
    t=2./(2.+z);
    ans=t*exp(-z*z-1.26551223+t*(1.000042368+t*(0.37409196+t*(0.09678418+
