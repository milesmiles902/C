...
vector<int> genLegalMoves(int id, int bdSize, vector<int> v) {
...
Graph knightGraph(int bdSize, vector<int> v) {
    Graph ktGraph(false);
...
int main() {
    ...
    vector<int> v = {1,1,0,\
                     0,0,0,\
                     0,1,1};
    Graph kt = knightGraph(size,v);
    kt = bfs(kt, kt.getVertex(3));
    traverse(kt.getVertex(2));
