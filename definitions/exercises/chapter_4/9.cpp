...
int main() {
    ...
    mylist.append(22);
    cout<<"Value (22) is appended to the list." << endl;
    cout<< mylist;
    cout<<"The index is: ";
    cout <<mylist.index(22)<<endl;
    mylist.pop();
    cout<<"A pop method removed 22 from the list."<<endl;
    cout<<"My list: "<<endl<<mylist;
    cout<<"The value 22 is again inserted." << endl;
    mylist.insert(22,2);
    cout<<"MY LIST: "<<endl<<mylist;
        return 0;
}
