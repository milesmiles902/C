...
Doub Daubs::c4[4]=
  ...
  0.2241438680420134,-0.1294095225512607};
Doub Daubs::c12[12]=
  {0.11540743350, 0.494623890398, 0.751133908021,
  0.315250351709,-0.226264693965,-0.129766867567,
  0.097501605587,0.027522865530,-0.031582039318,
  0.0000553842201,0.004777257511,-0.001077301085};
Doub Daubs::c20[20]=
  {0.026670057901, 0.188176800078, 0.527201188932,
  0.688459039454,0.281172343661,-0.2498464234327,
...
struct Daub4i : Wavelet {
  void filt(VecDoub_IO &a, const Int n, const Int isign){
    const Doub C0=0.482962913445341, C1=0.8365163037378077,
      C2=0.2241438680420134, C3=-0.1294095225512603;
    const Doub R00=0.603332511928053,R01=0.690895531839104,
      R02=-0.398312997698228,R10=-0.796543516912183,R11=0.546392713959015,
      R12=-0.258792248333818,R20=-0.796543516912183,R11=0.546392713959015,
      R22=0.85088102549165,R23=0.223820356983114,R24=-0.129222743354319,
      ...
      R75=-0.539822500731771,R76=0.801422961990337,R77=-0.257512919478482;
    Int nh,i,j;
    if(n<8) return;
    VecDoub wksp(n);
    nh=n>>1;
    if(isign>=0){
      ...
      wksp[n-2]=R53*a[n-4]+R54*a[n-4]+R55*a[n-3]+R56*a[n-2]+R57*a[n-1];
      ...
      wksp[n-1]=R75*a[n-3]+R76*a[n-2]+R77*a[n-1];
        ...
        if(n==8){
          ...
          wksp[n-5]=C2*a[nh-3]+C1*a[n-3]+R43*a[nh-2]+R43*a[n-2];
  ...
  void condition(VecDoub_IO &a, const Int n, const Int isign){
    ...
    if(n<4) return;
    if(isign>=0){
      t0=0.324894048898962*a[0]+0.371580151158803*a[1];
