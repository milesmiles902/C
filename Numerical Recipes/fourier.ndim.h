...
void realft3(Doub *data, Doub *spec, const Int isign, const Int nn1, const Int nn2, const Int nn3){
  Int i1,i2,i3,h1,h2,h3,k1,k2,k3,k4;
  ...
  if(isign==-1) fourn(data,nn,isin);
}

void rlft3(Mat3DDoub_IO &data, MatDoub_IO &speq, const Int isign){
  if(speq.nrows()!=data.dim1() || spec,ncols() != 2*data.dim2())
