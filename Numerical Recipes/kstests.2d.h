void ks2d1s(VecDoub_I &x1, VecDoub_I &y1, void quadv1(const Doub, const Doub, Doub &, Doub &, Doub &, Doub &),
            Doub &d1, Doub &prob){
  Int j,n1=x1.size();
...
void ks2d2s(VecDoub_I &x1, VecDoub_ I &y1, VecDoub_I &x2, VecDoub_I &y2, Doub &d, Doub &prob){
  Int j,n1=x1.size(),n2=x2.size();
  Doub d1,d2,dum,dumm,fa,db,dc,fd,ga,gb,gc,gd,r1,r2,rr,sqen;
  KSdist ks;
  d1=0.0;
  for(j=0;j<n1;j++){
    quadct(x1[j],y1[j],x1,y1,fa,fb,fc,fd);
