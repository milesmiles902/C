...
struct NRf1{
  Doub (*y1)(Doub);
  Doub (*y2)(Doub);
  NRf1(Doub yy1(Doub), Doub yy2(Doub), Doub z1(Doub, Doub), Doub z2(Doub, Doub)) : y1(yy1), y2(yy2), f2(z1,z2) {}
...
template <class T>
Doub quad3d (T &func, const Doub x1, const Doub x2, Doub y1(Doub), Doub y2(Doub), Doub z1(Doub,Doub),
